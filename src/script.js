...
const doorAlbedo = textureLoader.load("textures/door/albedo.jpg");
...
const bricksAlbedo = textureLoader.load("textures/bricks/albedo.jpg");
...
const grassAlbedo = textureLoader.load("textures/grass/albedo.jpg");
...
roof.position.y = 3; // height of the walls plus half the height of the roof
...
const tick = () => {
  ...
  ghost3.position.y = Math.sin(elapsedTime * 5) + Math.sin(elapsedTime * 0.5);
  ghost3.position.z = Math.sin(ghost3Angle) * (7 - Math.sin(elapsedTime + 0.5));
  const ghost4Angle = -elapsedTime * 0.5;
  ghost4.position.x = Math.cos(ghost4Angle) * 4;
  ghost4.position.y = Math.sin(elapsedTime * 3);
